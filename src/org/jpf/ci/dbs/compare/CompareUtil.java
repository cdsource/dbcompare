...
public class CompareUtil
{
			...
			throws Exception
	{
		...
		case 1:
		    ...
		    sb[0].append("<tr").append(strClassTypeString).append("><th scope=\"row\" abbr=\"L2 Cache\" class=\"specalt\">1")
		    .append("</th><td>")
		    .append(table.getTableName())
		...
		case 2:
			...
			sb[1].append("<tr ").append(strClassTypeString).append("><th scope=\"row\"  class=\"specalt\">2").append("</th><td>")
		    .append("</td><td></td><td ></td><td ></td>").append(table.getTableName()).append("<td ></td><td ></td></tr>");
		...
		case 3:
			...
			sb[2].append("<tr").append(strClassTypeString).append("><th scope=\"row\" abbr=\"L2 Cache\" class=\"specalt\">3").append("</th><td>").append(table.getTableName())
		    .append("</td><td >").append(pmdColumn.getColumnName()).append("</td><td >").append(pmdColumn.getDataType()).append("</td><td ></td><td ></td><td ></td></tr>");
			//System.out.println(sb[2]);
			break;
		case 4:
			System.out.println("4、PDM不存在，比对库存在的字段：" + table.getTableName()
					+ " | " + pmdColumn.getColumnName());// 需要人工判断脚本
			sb[3].append("<tr").append(strClassTypeString).append("><th scope=\"row\" abbr=\"L2 Cache\" class=\"specalt\">4").append("</th><td>")
			.append(table.getTableName())
		...
		case 5:
			...
			sb[4].append("<tr").append(strClassTypeString).append("><th scope=\"row\" abbr=\"L2 Cache\" class=\"specalt\">5").append("</th><td>").append(table.getTableName())
		...
		case 6:
			...
			sb[5].append("<tr").append(strClassTypeString).append("><th scope=\"row\" abbr=\"L2 Cache\" class=\"specalt\">6").append("</th><td>")
			.append(table.getTableName())
		    .append("</td><td >").append(pmdColumn.getColumnName())
