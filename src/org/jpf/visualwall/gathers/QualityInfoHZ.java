...
* @version 创建时间：2014年11月28日 下午2:24:40 
* 类说明 
*/ 
 ...
 * 
 */
public class QualityInfoHZ extends AbstractQualityInfo
{
	private static final Logger logger =  LogManager.getLogger();
	/**
	 * 
	 */
	public QualityInfoHZ()
	{
	...
	{
		// TODO Auto-generated method stub
		return "jdbc:mysql://10.10.12.153:3333/sonar";
	}
	/* (non-Javadoc)
	...
	String GetQuerySql()
	{
		...
		String strSql="select t1.id prj_id,DATE_FORMAT(t2.build_date,'%Y-%m-%d') build_date,"
				...
				+" from projects t1,snapshots t2,project_measures t3,bss_prj t4"
				+" where t1.scope='PRJ'  and t1.id=t4.prj_id and t1.enabled=1 and t1.id=t2.project_id  "
