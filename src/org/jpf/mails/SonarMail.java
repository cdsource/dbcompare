...
public class SonarMail
{
	private static final Logger logger = LogManager.getLogger(SonarMail.class);
	// private String host = "mail.asiainfo-linkage.com"; // smtp服务器
	private static String host = "10.1.1.201"; // smtp服务器
	private static final String username = "wupf"; // 用户名
	private static final String password = "qwe123$%^"; // 密码
	private static final String MailFrom = "wupf@asiainfo.com"; // 发件人地址
