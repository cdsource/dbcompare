...
public class JpfMail
{
	...
	private static final String host = "1.1.1.1"; // smtp服务器
	private static final String username = "aaa"; // 用户名
	private static final String password = "bbb"; // 密码
	private static final String MailFrom = "ccc@ddd.com"; // 发件人地址
